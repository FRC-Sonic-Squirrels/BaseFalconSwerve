...
public class Swerve extends SubsystemBase {
    ...
    public Swerve() {
        gyro = new Pigeon2(Constants.Swerve.pigeonID,Constants.Swerve.pigeonCANBusName);
    ...
    public void periodic(){
        ...
        for(SwerveModule mod : mSwerveMods){
            ...
            SmartDashboard.putNumber("Mod " + mod.moduleNumber + " Distance", mod.getModulePosition().distanceMeters);
        }
    }
}